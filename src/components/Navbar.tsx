...
import DskNav from "./DskNav";

const Navbar = () => {
  return (
    <nav className="flex items-center justify-between border-b border-gray-700 px-4 sm:px-6 py-2 md:px-12 md:py-3 lg:px-24 lg:py-5 z-10">
      <h2 className="text-base sm:text-2g md:text-3xl lg:text-4xl font-bold break-words">
